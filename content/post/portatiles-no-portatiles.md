---
title: "Las portátiles son cada vez menos portátiles"
...
Ya en los 2000 llegó la **Game Boy Advance** con un cambio de diseño para hacer entender que es una consola de nueva generación, y hoy en día es considerada una de las mejores consolas de la história. Era la mitad de pequeño que su predecesora, pero el verdadero rediseño que sorprendió fue el de la versión *SP*, una version con batería recargable, luz y la posibilidad de doblar por la mitad la consola para hacerla muchísimo más compacta todavía. Si la **Game Boy Advance** ya era pequeña, la *SP* era del tamaño de la pantalla de esta (doblada, claro).

Luego llegó la **DS** con su versión *lite* del tamaño de un móvil de esa época y la **PSP** con su diseño que no era mucho más grande que la DS Lite. Pero luego llegó el negocio de los modelos XL en la DSi, que prometían un mayor tamaño en general y de pantalla para los que tenían manos grandes.

Con 3DS pasó lo mismo, sacaron modelos XL que aún que seguían siendo compactos, se notaba que las consolas portátiles empezaban a alejarse del concepto de poder llevarse en el bolsillo como si nada.

Con la Switch abandonaron la doble pantalla, y con ello la función de doblar la consola. Eso provocó que para llevarla por ahí tenías que llevarte sí o sí una mochila o algo así porque no cabía en el bolsillo (por lo menos, no sin sobresalir una parte, tentando a la gente a ser robada). En esta consola también intentaron ofrecer una buena potencia para compensar el hecho de ser híbrida, mitad portátil mitad sobremesa.

Esta nueva idea de una consola portátil potente la aprovechó Steam para crear la Steam Deck, una *""portátil""* con una potencia comparable a la de un ordenador (claramente, un ordenador potente pero no uno de la NASA o ultra-gamer RTX etc.). ¡Podías jugar a juegos de Steam en cualquier lugar! ¿Lo malo? que es incluso más grande que la Switch en las 3 dimensiones y pesaba más del doble, así que no tenía sentido que sea portátil si para jugar comodamente necesites ser campeón de levantamiento de pesas.

Con la Steam Deck también llegaron más *ordenadores portátiles* de tamaños y pesos similares.
